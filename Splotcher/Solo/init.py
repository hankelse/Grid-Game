...
random_levels = False #True or False
...
#  - Two player (pvp?)
#     -   Teleporting: Hold shift and ghost version quickly moves and on release u teleport but if trail is cut off u lose
#  - Hide under dead smart cant see u 
